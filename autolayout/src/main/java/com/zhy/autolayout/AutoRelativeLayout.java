...
public class AutoRelativeLayout extends RelativeLayout
{
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom)
    {
      ...
      /*  int tempWindowHeight = ScreenUtils.getScreenHeight(getContext()) - ScreenUtils.getStatusBarHeight(getContext());
        //Util.windowHeight为事先缓存的高度
        if(tempWindowHeight != ScreenUtils.windowHeight){
            ScreenUtils.windowHeight = tempWindowHeight;
            ScreenUtils.windowWidth = ScreenUtils.getScreenWidth(getContext());
        }*/
    }
