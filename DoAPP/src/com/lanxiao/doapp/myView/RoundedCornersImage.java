...
public class RoundedCornersImage extends MaskedImage {
	...
	public Bitmap createMask() {
		...
		localPaint.setColor(getResources().getColor(R.color.main_kuang));
		float f1 = getWidth();
		float f2 = getHeight();
		...
		RectF StorkRectF = new RectF(0.0F, 0.0F, f1+2, f2+2);
		localCanvas.drawRoundRect(StorkRectF,f3,f4,localPaint);*/
