...
import com.lanxiao.doapp.entity.Orientations;
...
public class CardContainer extends AdapterView<ListAdapter> {
    public static final int[] CardContainer = {
            0x010100af, 0x7f01005b
    };
    public static final int CardContainer_android_gravity = 0;
    public static final int CardContainer_cardContainerOrientation = 1;
    ...
    private void initFromXml(AttributeSet attr) {
        ...
        setGravity(a.getInteger(CardContainer_android_gravity, Gravity.CENTER));
        int orientation = a.getInteger(CardContainer_cardContainerOrientation, 1);
