...
import com.lanxiao.doapp.zxing.camera.CameraManager;
...
public final class  ViewfinderView extends View
{
    ...
    public ViewfinderView(Context context, AttributeSet attrs)
    {
        ...
        frameColor = Color.GREEN;//resources.getColor(com.easemob.R.color.viewfinder_frame);
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        else
        {
            ...
            //		Drawable drawable =  getResources().getDrawable(com.easemob.R.drawable.qr_mask);
            ...
            //		canvas.drawBitmap(((BitmapDrawable)(getResources().getDrawable(com.easemob.R.drawable.qrcode_scan_line))).getBitmap(), null, lineRect, paint);
            ...
            canvas.drawText(
                    ...
                    getWidth()/2, frame.bottom + TEXT_PADDING_TOP * density,
                    paint);
