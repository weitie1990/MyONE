...
import com.lanxiao.doapp.activity.ChatRoomDetailsActivity;
import com.lanxiao.doapp.activity.ContextMenuActivity;
import com.lanxiao.doapp.activity.ForwardMessageActivity;
import com.lanxiao.doapp.activity.GroupDetailsActivity;
...
import com.lanxiao.doapp.chatui.applib.chatuimain.domain.ChatRowVoiceCall;
...
public class ChatFragment extends EaseChatFragment implements EaseChatFragmentListener {
    ...
    protected void registerExtendMenuItem() {
        ...
        if(chatType == Constant.CHATTYPE_SINGLE){
            inputMenu.registerExtendMenuItem(R.string.attach_voice_call, R.drawable.chat_voice_call_selector, ITEM_VOICE_CALL, extendMenuItemClickListener);
            inputMenu.registerExtendMenuItem(R.string.attach_video_call, R.drawable.chat_video_call_selector, ITEM_VIDEO_CALL, extendMenuItemClickListener);
        }
    }
    ...
    public void onAvatarClick(String username) {
        //头像点击事件
        Utils.intoInfo(getActivity(),username);
