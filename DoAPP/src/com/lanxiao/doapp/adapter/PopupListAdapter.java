...
public class PopupListAdapter extends RecyclerView.Adapter<PopupListAdapter.ViewHolder> {
        ...
        if (onPopupListClickListener != null) {
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    onPopupListClickListener.onPopupListItemClick(contextView, contextPosition, holder.itemView, position,type);
    ...
    public interface OnPopupListClickListener {
        void onPopupListItemClick(View contextView, int contextPosition, View view, int position,int type);
    }
