 ...
 * 
 */
public class ArcMenu extends AutoRelativeLayout {
    private com.lanxiao.doapp.capricorn.ArcLayout mArcLayout;
    ...
    private void init(Context context) {
        ...
        mArcLayout = (com.lanxiao.doapp.capricorn.ArcLayout) findViewById(R.id.item_layout);
    ...
    private void applyAttrs(AttributeSet attrs) {
        if (attrs != null) {
            ...
            float fromDegrees = a.getFloat(R.styleable.ArcLayout_fromDegrees, com.lanxiao.doapp.capricorn.ArcLayout.DEFAULT_FROM_DEGREES);
            ...
            LogUtils.i(newChildSize+"");
            a.recycle();
        }
    }
    public void addOntouchListen(OnTouchListener onTouchListener){
        this.onTouchListener=onTouchListener;
        controlLayout.setOnTouchListener(onTouchListener);
    }
    public void addItem(View item, OnClickListener listener) {
        Log.i("weitie", "additem");
