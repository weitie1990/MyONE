...
public class EaseChatFragment extends EaseBaseFragment implements EMEventListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
       ...
       // aver=fragmentArgs.getString(EaseConstant.AVER);
    ...
    protected void setUpView() {
        LogUtils.i("setUpView");
        MyUtils.setNickNameandAver(toChatUsername, titleBar,getContext());
        if (chatType == EaseConstant.CHATTYPE_SINGLE) { // 单聊
            // 设置标题
            if(EaseUserUtils.getUserInfo(toChatUsername) != null){
                //titleBar.setTitle(Conversion.getInstance().getNickName());
                LogUtils.i("tochatname");
                MyUtils.setNickNameandAver(toChatUsername,titleBar,getContext());
            }
            titleBar.setRightImageResource(R.drawable.chat_delete);
        } else {
            //TODO 这是群聊页的入口
        	titleBar.setRightImageResource(R.drawable.iv_group);
