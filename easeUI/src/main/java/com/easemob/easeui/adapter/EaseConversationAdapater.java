...
public class EaseConversationAdapater extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            MyUtils.setNickNameandAver(username,holder.avatar,holder.name,getContext());
            /*if(TextUtils.isEmpty(contactList.get(position).getAvatar())){
                ...
                bitmapUtils.display(holder.avatar, contactList.get(position).getAvatar());
            }
            holder.name.setText(contactList.get(position).getNickName());*/
        }
