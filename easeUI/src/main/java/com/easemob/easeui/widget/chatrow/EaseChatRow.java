...
public abstract class EaseChatRow extends AutoLinearLayout {
    ...
    private void setUpBaseView() {
        ...
        if(message.direct == Direct.SEND){
            ...
            EaseUserUtils.setAver(Conversion.getInstance().getHeadUrl(),userAvatarView);
...
//            UserUtils.setUserNick(EMChatManager.getInstance().getCurrentUser(), usernickView);
           ...
           // EaseUserUtils.setUserNick(message.getFrom(), usernickView);
            ...
            MyUtils.setNickNameandAver(message.getFrom(),userAvatarView,usernickView,context);
        }
